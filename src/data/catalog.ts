...
export const SKUS: Sku[] = [
  // ── Breakfast & Cereal ────────────────────────────────────────────────
  { id: 'frosted-corn-flakes', name: 'Morning Mills Frosted Corn Flakes', price: 4.49, unit: '13.5 oz box', dept: 'Breakfast & Cereal', nutrition: { sugar: 12, protein: 1, sodium: 150 }, tags: ['featured'], stockNote: 'Many in stock', buyItAgain: true },
  ...
  { id: 'nut-bars-dark-choc', name: 'Alpine Almond & Dark Chocolate Bars', price: 4.29, unit: '5 bars', dept: 'Breakfast & Cereal', nutrition: { sugar: 4, protein: 6, sodium: 65 }, tags: ['healthier', 'more-protein'] },
  ...
  { id: 'salted-nuts', name: 'Orchard Valley Roasted & Salted Mixed Nuts', price: 8.99, unit: '16 oz jar', dept: 'Snacks', nutrition: { sugar: 1, protein: 6, sodium: 170 }, tags: ['featured'] },
  { id: 'unsalted-nuts', name: 'Orchard Valley Unsalted Mixed Nuts', price: 8.99, unit: '16 oz jar', dept: 'Snacks', nutrition: { sugar: 1, protein: 6, sodium: 0 }, tags: ['healthier', 'less-sodium'] },
  { id: 'applesauce-sweetened', name: 'Orchard Valley Sweetened Applesauce Cups', price: 3.29, unit: '4 oz cups, 6 ct', dept: 'Snacks', nutrition: { sugar: 22, protein: 0, sodium: 10 }, tags: ['featured'] },
  { id: 'applesauce-unsweetened', name: 'Orchard Valley Unsweetened Applesauce Cups', price: 3.29, unit: '4 oz cups, 6 ct', dept: 'Snacks', nutrition: { sugar: 11, protein: 0, sodium: 0 }, tags: ['healthier'] },
  { id: 'hummus', name: 'Zaytoun Classic Hummus', price: 3.99, unit: '10 oz tub', dept: 'Snacks', nutrition: { sugar: 1, protein: 2, sodium: 130 }, tags: ['healthier'], stockNote: 'Many in stock' },
  ...
  { id: 'lime-sparkling-12pk', name: 'Cascade Lime Sparkling Water', price: 5.49, unit: '12 fl oz cans, 12 ct', dept: 'Beverages', nutrition: { sugar: 0, protein: 0, sodium: 0 }, tags: ['healthier'], stockNote: 'Many in stock' },
  { id: 'orange-soda-2l', name: 'Fizzi Orange Soda', price: 2.79, unit: '2 L bottle', dept: 'Beverages', nutrition: { sugar: 44, protein: 0, sodium: 60 }, tags: ['featured'] },
  { id: 'orange-sparkling-1l', name: 'Cascade Orange Sparkling Water', price: 2.49, unit: '1 L bottle', dept: 'Beverages', nutrition: { sugar: 0, protein: 0, sodium: 5 }, tags: ['healthier'] },
  ...
  { id: 'orange-juice', name: 'Grove Press 100% Orange Juice', price: 5.49, unit: '52 fl oz', dept: 'Beverages', nutrition: { sugar: 22, protein: 1, sodium: 0 }, tags: [] },
  ...
  { id: 'milk-2pct', name: 'Meadowbrook 2% Reduced-Fat Milk', price: 4.29, unit: '1 gal', dept: 'Dairy & Eggs', nutrition: { sugar: 12, protein: 8, sodium: 120 }, tags: ['featured'], stockNote: 'Many in stock' },
  { id: 'uf-milk', name: 'Peak Ultra-Filtered 2% Milk', price: 4.79, unit: '52 fl oz', dept: 'Dairy & Eggs', nutrition: { sugar: 6, protein: 13, sodium: 135 }, tags: ['healthier', 'more-protein'] },
  ...
  { id: 'cheddar', name: 'Coastal Sharp Cheddar', price: 4.99, unit: '8 oz block', dept: 'Dairy & Eggs', nutrition: { sugar: 0, protein: 7, sodium: 180 }, tags: [] },
  ...
  { id: 'penne', name: 'Bella Grano Penne Rigate', price: 1.89, unit: '16 oz', dept: 'Pantry & Canned', nutrition: { sugar: 1, protein: 6, sodium: 0 }, tags: ['featured'], stockNote: 'Many in stock', buyItAgain: true },
  { id: 'chickpea-penne', name: 'Verde Legume Chickpea Penne', price: 2.19, unit: '8 oz', dept: 'Pantry & Canned', nutrition: { sugar: 2, protein: 13, sodium: 45 }, tags: ['healthier', 'more-protein'] },
  ...
  { id: 'white-rice', name: 'Golden Harvest Long-Grain White Rice', price: 2.99, unit: '2 lb bag', dept: 'Pantry & Canned', nutrition: { sugar: 0, protein: 3, sodium: 0 }, tags: ['featured'], stockNote: 'Many in stock' },
  { id: 'quinoa', name: 'Andes Gold Tri-Color Quinoa', price: 3.49, unit: '12 oz bag', dept: 'Pantry & Canned', nutrition: { sugar: 1, protein: 8, sodium: 5 }, tags: ['healthier', 'more-protein'] },
  ...
  { id: 'white-bread', name: 'Hearthside White Sandwich Bread', price: 2.99, unit: '20 oz loaf', dept: 'Pantry & Canned', nutrition: { sugar: 2, protein: 3, sodium: 135 }, tags: [], stockNote: 'Many in stock', buyItAgain: true },
  { id: 'wheat-bread', name: 'Hearthside 100% Whole-Wheat Bread', price: 3.29, unit: '20 oz loaf', dept: 'Pantry & Canned', nutrition: { sugar: 3, protein: 4, sodium: 130 }, tags: ['healthier'] },
...
// dimension and close in price. Reason copy leads with the concrete benefit,
// uses the real numbers above, and never moralizes.
export const RECS: Rec[] = [
  ...
  },
  {
    ...
    dimensions: ['Less sugar'],
    reason: 'Same apples, same price — skipping the added sugar takes each cup from 22g down to 11g.',
  },
  {
    forSku: 'orange-soda-2l',
    pick: 'orange-sparkling-1l',
    dimensions: ['Less sugar'],
    reason: 'Bright orange fizz with zero sugar, instead of 44g per glass — and it’s 30¢ less.',
  },
  {
    forSku: 'penne',
    pick: 'chickpea-penne',
  ...
  },
  {
    ...
    pick: 'quinoa',
    dimensions: ['More protein'],
    reason: '8g of protein per cup to rice’s 3 — and it cooks in the same 15 minutes.',
  },
  {
    forSku: 'milk-2pct',
    pick: 'uf-milk',
    dimensions: ['More protein'],
    reason: 'Same 2% taste, 13g of protein per glass instead of 8.',
  },
  {
    forSku: 'sour-cream',
    pick: 'greek-yogurt-tub',
    dimensions: ['More protein'],
    reason: 'Swaps one-for-one in tacos and dips, with 6g of protein per scoop instead of 1.',
    contextVariants: [
      {
        ifInCart: 'tortilla-chips',
        reason: 'Next to those tortilla chips, plain Greek dips just as well — 6g of protein per scoop instead of 1.',
      },
    ],
  },
  {
    ...
    reason: 'You’ve had this one before — the low-sodium version is the same recipe with about half the salt.',
  },
  {
    forSku: 'soy-sauce',
    pick: 'soy-sauce-rs',
  ...
  },
  {
    ...
    pick: 'marinara-nsa',
    dimensions: ['Less sodium'],
    reason: 'Same tomatoes and basil, 40mg of sodium instead of 480.',
    contextVariants: [
      {
        ifInCart: 'penne',
        reason: 'For the pasta night in your cart — same tomatoes and basil, about a tenth of the sodium.',
      },
      {
